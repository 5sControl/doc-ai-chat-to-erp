...
class SummaryTile extends StatefulWidget {
  // final AppLifecycleState? appLifecycleStatus;
  ...
  Widget build(BuildContext context) {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => SummaryScreen(
                  ...
                  displayLink: widget.summaryData.title ?? displayLink,
    ...
    return BlocListener<SharedLinksBloc, SharedLinksState>(
      listenWhen: (previous, current) {
        return previous.savedLinks[widget.sharedLink]?.status != current.savedLinks[widget.sharedLink]?.status;
      },
      listener: (context, state) {
        if (state.savedLinks[widget.sharedLink]?.status ==
                SummaryStatus.Complete &&
            state.savedLinks[widget.sharedLink]?.opened == false) {
          print('Open');
          onPressSharedItem();
        } else {
          print('dont open');
